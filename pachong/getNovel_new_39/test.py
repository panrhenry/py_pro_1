...
def search_company(page, origin_name, companyname):
    """按公司搜索加载明细数据"""
    page.frame_locator("iframe >> nth=0").get_by_title(origin_name).click()
    time.sleep(2)
...
def run(playwright: Playwright) -> None:
    ...
    companyname = "驻马店市产业投资集团有限公司"
    search_company(page, origin_name, companyname)
    ...
    while i <= len(details_1) - 1:
        ...
        i = i + 15
    time.sleep(2)
    # df.to_csv("detail_zq.csv",encoding='UTF-8')
